  ...
  textStr={`${gitIndex.headers.signature} ${gitIndex.headers.version} ${
   ...
   ${gitIndex.entries
     .map(
       (
         e
       ) => `${e.headers.ctimeSeconds} ${e.headers.ctimeNanoSeconds} ${e.headers.mtimeSeconds} ${e.headers.mtimeNanoSeconds} ${e.headers.dev} ${e.headers.ino} ${e.headers.mode} ${e.headers.uid} ${e.headers.gid} ${e.headers.file}\
